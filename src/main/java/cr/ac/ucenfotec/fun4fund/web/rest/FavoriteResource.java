...
/**
 * REST controller for managing {@link cr.ac.ucenfotec.fun4fund.domain.Favorite}.
 */
@RestController
@RequestMapping("/api")
public class FavoriteResource {
    ...
    public ResponseEntity<List<Favorite>> getAllFavorites(FavoriteCriteria criteria) {
        log.debug("REST request to get Favorites by criteria: {}", criteria);
        List<Favorite> entityList = favoriteQueryService.findByCriteria(criteria);
