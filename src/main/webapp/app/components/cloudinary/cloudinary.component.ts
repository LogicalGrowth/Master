...
export class CloudinaryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.uploader.onCompleteItem = (item: any, response: string) => {
      this.progressBar.set(96, 'Verificando imagen.', false);
      this.progressBar.set(100, 'Imagen guardada.', false);
      setTimeout(() => {
