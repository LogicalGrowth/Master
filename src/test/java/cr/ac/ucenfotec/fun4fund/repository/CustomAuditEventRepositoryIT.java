...
import cr.ac.ucenfotec.fun4fund.config.audit.AuditEventConverter;
...
import static cr.ac.ucenfotec.fun4fund.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
